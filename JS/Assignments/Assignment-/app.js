...
// document.write(Math.round(myNum))
...
if (userWeight==50 || userWeight==50+"kgs" || userWeight==50.2+"kgs"||userWeight==50.2+"kilograms"){
  document.write("Ypur weight is: " + userWeight)
}

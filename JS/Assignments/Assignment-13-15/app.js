...
var student3 = ["Wania", "Areeha", "Ruhma"];
...
document.write('</br>' + phoneManufactures.shift(1)+ '</br>'+ phoneManufactures.shift(2)+ '</br>'+phoneManufactures.shift(3)+ '</br>'+phoneManufactures.shift(4)+ '</br>'+phoneManufactures.shift(5))